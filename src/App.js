    ...
    <Canvas gl={{ antialias: false }} dpr={[1, 1.5]}>
      <Suspense fallback={null}>
        <ScrollControls infinite horizontal damping={4} pages={4} distance={1}>
          ...
          <Scroll html>
            <h1 style={{ position: 'absolute', top: '20vh', left: '-75vw' }}>DSR</h1>
            <h1 style={{ position: 'absolute', top: '20vh', left: '25vw' }}>PTV</h1>
            <h1 style={{ position: 'absolute', top: '20vh', left: '125vw' }}>REC</h1>
            <h1 style={{ position: 'absolute', top: '20vh', left: '225vw' }}>SHOP</h1>
            <h1 style={{ position: 'absolute', top: '20vh', left: '325vw' }}>DSR</h1>
            <h1 style={{ position: 'absolute', top: '20vh', left: '425vw' }}>PTV</h1>
          </Scroll>
        </ScrollControls>
        <Preload />
      </Suspense>
